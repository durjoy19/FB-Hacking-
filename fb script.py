...
def banner():
   ...
   \033[33;1m     ____  ____ ___  _
   \033[31;1m     /  __\/  _ \\  \//
   \033[34;1m    /  __\/  _ \\  \//
   \033[32;1m   |    /| \_/| / /    
   \033[30;1m     \_/\_\\____//_/              
  \033[91;1m  ╔════════════════════════════════════════╗
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/MR-ROY");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=100087308264850");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}MR-ROY {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100087308264850");time.sleep(3);os.system('xdg-open https://www.facebook.com/profile.php?id=100087308264850');exit()
    else:
